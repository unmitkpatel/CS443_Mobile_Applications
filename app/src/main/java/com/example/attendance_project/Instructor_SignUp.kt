...
class Instructor_SignUp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usernameInput = findViewById<EditText>(R.id.textView3)
        var passwordInput = findViewById<EditText>(R.id.editTextTextPassword2)
        var credentialsdb: Instructors_Credentials
        credentialsdb = Instructors_Credentials(this)
        createAccountButton.setOnClickListener {
            if(usernameInput.text.toString().isEmpty() || passwordInput.text.toString().isEmpty()) {
                ...
                if (check) {
                    ...
                    val method: SQL_Content_for_Instructor = SQL_Content_for_Instructor(this)
                    method.setUsername(usernameInput.text.toString())
                    val Intent = Intent(this, Instructor_MainPage::class.java)
